...
def call_explainer(mistake, correct_sentence, user_sentence):
  ...
  print(f"Hint: {hint}")
  # 목소리 (STT, TTS)0
  node = TextNode(text=mistake, metadata={'correct_sentence': correct_sentence, 'user_sentence': user_sentence})
...
st.header("Role Play Development 엽기떡볶이")
